    ...
    >
      <CardContent className="p-4 lg:p-6">
        ...
        <div className="block lg:hidden">
          ...
          <div className="mb-4 pb-3 border-b border-gray-100">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0">
                <div className="w-10 h-10 bg-spark-50 rounded-xl flex items-center justify-center">
                  {icon}
                </div>
              </div>
              ...
              <div className="flex-1 min-w-0">
                {applicationNumber && (
                  <div className="text-xs text-gray-500 mb-1">
                    ID da solicitação: {applicationNumber}
                  </div>
                )}
                
                <h3 className="font-semibold text-gray-900 text-base mobile-title-truncate mb-1">
                  {title}
                </h3>
                
                {companyBadge && (
                  <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 text-xs mobile-badge-truncate">
                    {companyBadge}
                  </Badge>
                )}
              </div>
          ...
          {/* Status and Credit Score Container */}
          <div className="mb-4 pb-3 border-b border-gray-100">
          ...
          {/* Mini Cards - Single Column Layout */}
            ...
            <div className="flex items-start space-x-3 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-3 mb-2">
                  <h3 className="font-semibold text-gray-900 text-base lg:text-lg lg:truncate">
                    {title}
                  </h3>
                  {companyBadge && (
