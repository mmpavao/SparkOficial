...
function ImportBasicInfo({ importData }: { importData: any }) {
  const getStatusBadge = (status: string) => {
    const statusMap = {
      estimativa: { label: "Estimativa", color: "bg-gray-100 text-gray-700", bgColor: "bg-gray-50" },
      producao: { label: "Produção", color: "bg-blue-100 text-blue-700", bgColor: "bg-blue-50" },
      entregue_agente: { label: "Entregue Agente", color: "bg-yellow-100 text-yellow-700", bgColor: "bg-yellow-50" },
      transporte_maritimo: { label: "Transporte Marítimo", color: "bg-indigo-100 text-indigo-700", bgColor: "bg-indigo-50" },
      transporte_aereo: { label: "Transporte Aéreo", color: "bg-purple-100 text-purple-700", bgColor: "bg-purple-50" },
      desembaraco: { label: "Desembaraço", color: "bg-orange-100 text-orange-700", bgColor: "bg-orange-50" },
      transporte_nacional: { label: "Transporte Nacional", color: "bg-cyan-100 text-cyan-700", bgColor: "bg-cyan-50" },
      concluido: { label: "Concluído", color: "bg-green-100 text-green-700", bgColor: "bg-green-50" },
      planning: { label: "Planejamento", color: "bg-gray-100 text-gray-700", bgColor: "bg-gray-50" },
    };
...
function ImportTimeline({ importData }: { importData: any }) {
  const timelineSteps = [
    ...
    { key: 'transporte_maritimo', label: 'Transporte Marítimo', icon: Package },
    { key: 'transporte_aereo', label: 'Transporte Aéreo', icon: Package },
    { key: 'desembaraco', label: 'Desembaraço', icon: FileText },
    { key: 'transporte_nacional', label: 'Transporte Nacional', icon: Package },
