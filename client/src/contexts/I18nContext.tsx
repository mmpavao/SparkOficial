  ...
  en: {
    ...
    financeira: {
      ...
      analysis: {
        ...
        // Credit analysis page specific translations
        approved: 'Approved',
        inAnalysis: 'In Analysis', 
        pending: 'Pending',
        ...
        reason: 'Reason',
        submitted: 'Submitted',
        statusPreAnalysis: 'Pre-Analysis',
        statusFinalAnalysis: 'Final Analysis', 
        statusPreApproved: 'Pre-approved',
        statusApproved: 'Approved',
        statusRejected: 'Rejected',
        ...
        edit: 'Edit',
        cancel: 'Cancel',
        confirmCancel: 'Are you sure you want to cancel this credit application?',
        cancelSuccess: 'Credit application cancelled successfully',
        cancelError: 'Error cancelling credit application'
      },
      preview: {
