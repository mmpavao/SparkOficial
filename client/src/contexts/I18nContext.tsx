  ...
  en: {
    ...
    financeira: {
      dashboard: {
        ...
        totalApproved: 'Volume Granted',
        beingUtilized: 'Being Used',
        creditAvailable: 'Available Credit',
        availableForUse: 'Free for Use',
      ...
      // Credit analysis page - English
      analysis: {
        title: 'Credit Analysis',
        searchPlaceholder: 'Search by company name or CNPJ...',
        statusAll: 'All Status',
        statusPending: 'Pending',
        statusUnderReview: 'Under Review',
        statusPreApproved: 'Pre-approved',
        statusSubmittedToFinancial: 'Submitted to Finance',
        statusFinanciallyApproved: 'Financially Approved',
        ...
        mandatoryPending: '{count} Mandatory Pending',
        ...
        rejectCredit: 'Reject Credit',
        confirmApproval: 'Confirm Approval',
        confirmRejection: 'Confirm Rejection',
        approvalMessage: 'Are you sure you want to approve this credit application?',
        rejectionMessage: 'Are you sure you want to reject this credit application?',
        ...
        adminFee: 'Admin Fee',
        insurancePolicy: 'Insurance Policy Coverage',
        totalApplications: 'Total Applications',
        ...
        reviewSection: 'Financial Review',
        approvalSection: 'Approval Decision',
        rejectionReason: 'Rejection Reason',
        otherReason: 'Other (specify)',
        ...
        // Additional translations for credit page
        ...
        evaluateAndApprove: 'Evaluate and approve pre-analyzed credit applications by administration',
        viewAndManage: 'View and manage all platform credit applications',
        requestCredit: 'Request credit for your imports',
        ...
        requestDetails: 'Credit request details',
        ...
        requestCancelled: 'Credit request cancelled successfully',
        cancelError: 'Could not cancel the request. Please try again.'
      },
      preview: {
