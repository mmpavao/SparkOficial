...
const defaultTranslations: Record<Language, Translations> = {
  pt: {
    ...
    financial: {
      ...
      creditRequestDetails: 'Detalhes da solicitação de crédito',
      ...
      phone: 'Telefone',
      address: 'Endereço',
      creditInformation: 'Informações do Crédito',
      requestedAmount: 'Valor Solicitado',
      monthlyImportVolume: 'Volume Mensal de Importação',
      businessSector: 'Setor de Negócio',
      annualRevenue: 'Receita Anual',
      productsToImport: 'Produtos para Importar',
      justification: 'Justificativa',
      creditApplicationStatus: 'Status da Solicitação de Crédito',
      applicationSent: 'Solicitação Enviada',
      applicationSuccessful: 'Sua aplicação foi enviada com sucesso',
      preAnalysisCompleted: 'Pré-análise Concluída',
      documentsApproved: 'Documentos aprovados pela nossa equipe',
      financialAnalysisApproved: 'Análise Financeira Aprovada',
      creditApprovedByFinancial: 'Crédito aprovado pela instituição financeira',
      creditApproved: 'Crédito Aprovado',
      processFinalized: 'Processo finalizado - crédito disponível',
      applicationProgress: 'Progresso da Solicitação',
  ...
  en: {
    ...
    financial: {
      ...
      requestedAmount: 'Requested Amount',
      monthlyImportVolume: 'Monthly Import Volume',
      businessSector: 'Business Sector',
      annualRevenue: 'Annual Revenue',
      productsToImport: 'Products to Import',
      justification: 'Justification',
      creditApplicationStatus: 'Credit Application Status',
      applicationSent: 'Application Sent',
      applicationSuccessful: 'Your application was submitted successfully',
      preAnalysisCompleted: 'Pre-Analysis Completed',
      documentsApproved: 'Documents approved by our team',
      financialAnalysisApproved: 'Financial Analysis Approved',
      creditApprovedByFinancial: 'Credit approved by financial institution',
      creditApproved: 'Credit Approved',
      processFinalized: 'Process finalized - credit available',
  ...
  zh: {
    ...
    financial: {
      ...
      phone: '电话',
      address: '地址',
      creditInformation: '信贷信息',
      requestedAmount: '申请金额',
      monthlyImportVolume: '月进口量',
      businessSector: '业务领域',
      annualRevenue: '年收入',
      productsToImport: '进口产品',
      justification: '申请理由',
      creditApplicationStatus: '信贷申请状态',
      applicationSent: '申请已提交',
      applicationSuccessful: '您的申请已成功提交',
      preAnalysisCompleted: '预审完成',
      documentsApproved: '文件已获我们团队批准',
      financialAnalysisApproved: '财务分析已批准',
      creditApprovedByFinancial: '信贷已获金融机构批准',
      creditApproved: '信贷已批准',
      processFinalized: '流程已完成 - 信贷可用',
