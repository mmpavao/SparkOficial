...
export class DatabaseStorage {
  ...
  async createCreditScore(scoreData: any): Promise<CreditScore> {
    // Format data for Direct Data structure
    const formattedData = {
      creditApplicationId: scoreData.creditApplicationId,
      cnpj: scoreData.cnpj,
      creditScore: scoreData.creditScore || 0,
      scoreCategory: scoreData.scoreCategory,
      riskLevel: scoreData.riskLevel,
      scoreMotivos: scoreData.scoreMotivos || [],
      scoreObservacao: scoreData.scoreObservacao,
      razaoSocial: scoreData.razaoSocial,
      nomeFantasia: scoreData.nomeFantasia,
      situacaoCadastral: scoreData.situacaoCadastral,
      naturezaJuridica: scoreData.naturezaJuridica,
      dataFundacao: scoreData.dataFundacao,
      atividadePrincipal: scoreData.atividadePrincipal,
      capitalSocial: scoreData.capitalSocial,
      quantidadeFiliais: scoreData.quantidadeFiliais || 0,
      endereco: scoreData.endereco || {},
      email: scoreData.email,
      telefone: scoreData.telefone,
      statusPendencia: scoreData.statusPendencia,
      totalPendencia: scoreData.totalPendencia,
      quantidadeProtestos: scoreData.quantidadeProtestos || 0,
      valorProtestos: scoreData.valorProtestos,
      protestos: scoreData.protestos || [],
      quantidadeAcoes: scoreData.quantidadeAcoes || 0,
      valorAcoes: scoreData.valorAcoes,
      acoesJudiciais: scoreData.acoesJudiciais || [],
      quantidadeRecuperacoes: scoreData.quantidadeRecuperacoes || 0,
      valorRecuperacoes: scoreData.valorRecuperacoes,
      recuperacoesJudiciais: scoreData.recuperacoesJudiciais || [],
      quantidadeChequesSemFundo: scoreData.quantidadeChequesSemFundo || 0,
      chequesSemFundo: scoreData.chequesSemFundo || [],
      indicadoresNegocio: scoreData.indicadoresNegocio || [],
      consultas30Dias: scoreData.consultas30Dias || 0,
      consultas60Dias: scoreData.consultas60Dias || 0,
      consultas90Dias: scoreData.consultas90Dias || 0,
      consultasMais90Dias: scoreData.consultasMais90Dias || 0,
      detalhesConsultas: scoreData.detalhesConsultas || [],
      socios: scoreData.socios || [],
      consultaUid: scoreData.consultaUid,
      tempoExecucao: scoreData.tempoExecucao,
      apiVersao: scoreData.apiVersao,
      directDataResponse: scoreData.directDataResponse || {},
      consultaStatus: scoreData.consultaStatus || 'success',
      errorMessage: scoreData.errorMessage
    };
