...
<body>
  ...
  app.post('/api/credit/applications/:id/credit-score', requireAuth, async (req: any, res) => {
    try {
      ...
      // Receita WS API temporarily disabled
      console.log('📋 Receita WS API temporarily disabled - all external credit APIs removed');
      receitaData = null;
      ...
      // Step 3: Location photo APIs temporarily disabled
      console.log('📋 Location photo APIs temporarily disabled - no external photo fetching');
